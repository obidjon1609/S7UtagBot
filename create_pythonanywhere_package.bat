...
powershell -Command "Compress-Archive -Path 'pro.tag.10.py', 'requirements.txt', 'run.bat', 'hot_reload.bat', 'hot_reload.py', 'pythonanywhere_final_guide.md', '.env.template', 'README.md' -DestinationPath 'pro_tag_bot_pythonanywhere.zip' -Force"
